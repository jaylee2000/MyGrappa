...
def grappa(
    ...
    Original Code
    ----------
    https://github.com/mckib2/pygrappa/blob/main/pygrappa/grappa.py
    '''
    ...
    # If kernel is odd, window for applying weights will be right-sided
    #     S = kspace[xx-kx2:xx+kx2+adjx, yy-ky2:yy+ky2+adjy, :]
    # where xx, yy is location of target
    adjx = np.mod(kx, 2)
    adjy = np.mod(ky, 2)
    ...
    with NTF() as fP, NTF() as fA, NTF() as frecon:
        ...
        # The recon array has been zero padded, so crop it down
